...
\header{\LARGE{Appointment}}
\begin{body}
	\vspace{18pt}
	Assistant Professor, Department of Statistics and the College, University of Chicago \hfill \emph{July~2021 - present} \\
\end{body}
...
\begin{body}
	\vspace{18pt}
	\textbf{\large{University of California, Berkeley}}, CA, USA \hfill \emph{June~2020 - June~2021} \\
    \begin{itemize}
      \item[-] Postdoc, Department of Statistics and Department of Electrical Engineering and Computer Sciences,
      \item[-] Advisor: Professor \emph{Martin J.~Wainwright}
      %\item GPA: 3.976 / 4.0
    \end{itemize}
	\textbf{\large{Princeton University}}, NJ, USA \hfill \emph{Sept.~2015 - June 2020} \\
    \begin{itemize}
      \item[-] Ph.D., Department of Operations Research and Financial Engineering
      \item[-] Advisors: Professor \emph{Yuxin Chen} and Professor \emph{Jianqing Fan}
      %\item GPA: 3.976 / 4.0
    \end{itemize}
    \textbf{\large{Tsinghua University}}, Beijing, China \hfill \emph{Aug.~2011 - July 2015} \\
    \begin{itemize}
      \item[-] Bachelor of Engineering, Department of Electrical Engineering
    \end{itemize}
    \textbf{\large{Georgia Institute of Technology}}, GA, USA \hfill \emph{Aug.~2013 - Dec.~2013} \\
    \begin{itemize}
      \item[-] Exchange student, School of Electrical and Computer Engineering
    \end{itemize}
\end{body}
...
\item P.~Rashidinejad, B.~Zhu, \textbf{C.~Ma}, J.~Jiao, S.~Russel, {``Bridging Offline Reinforcement Learning and Imitation Learning: A Tale of Pessimism,''} 2021. \\
...
\item Y.~Chen, Y.~Chi, J.~Fan, \textbf{C.~Ma} (\textbf{alphabetical order}), {``Spectral Methods for Data Science: A Statistical Perspective,''} accepted to \emph{Foundations and Trends in Machine Learning}, 2021. \\
