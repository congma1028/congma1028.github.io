...
\begin{body}
\vspace{18pt}
Mathematics of data science, nonconvex optimization,  transfer learning, reinforcement learning, high-dimensional statistics, inference and uncertainty quantification, and their applications to signal processing.
\end{body}
...
\begin{body}
	...
	\item Y.~Yang, \textbf{C.~Ma}, ``Estimating Shared Subspace with AJIVE: The Power and Limitation of Multiple Data Matrices," 2025.
...
\item B.~Zhao, \textbf{C.~Ma}, M.~Kolar, ``Trans-Glasso: A Transfer Learning Approach to Precision Matrix Estimation," under Major Revision with \emph{Journal of the American Statistical Association}, 2024.
...
\begin{body}
	...
	\item UC Davis, Statistics Seminar, Apr.~2025. 
